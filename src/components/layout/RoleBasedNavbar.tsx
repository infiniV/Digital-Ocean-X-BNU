...
export function RoleBasedNavbar({ session, userRole }: NavbarProps) {
  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-notion-gray-light/10 bg-notion-background/80 backdrop-blur-md dark:border-notion-gray-dark/20 dark:bg-notion-background-dark/80">
          ...
          {user ? (
            <div className="flex items-center gap-4">
              ...
              <div className="relative flex items-center gap-3">
                ...
                >
                  <button className="flex items-center gap-2 rounded-md px-3 py-2 font-geist text-sm font-medium text-notion-text-light/80 transition-all hover:bg-notion-gray-light/10 hover:text-notion-pink dark:text-notion-text-dark/80 dark:hover:bg-notion-gray-dark/20">
                    <LogOut size={16} />
                    <span>Sign out</span>
                  </button>
                </form>
            ...
            >
              <button className="flex items-center gap-2 rounded-md bg-notion-pink px-4 py-2 font-geist text-sm font-medium text-notion-text-dark shadow-sm transition-all hover:bg-notion-pink-dark hover:shadow-md">
                Sign in
              </button>
            </form>
          )}
