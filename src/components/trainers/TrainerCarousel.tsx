...
export function TrainerCarousel({ trainers }: TrainerCarouselProps) {
    ...
    return (
      <div className="container mx-auto py-notion-lg">
        <div className="rounded-xl bg-notion-gray-light/30 p-16 dark:bg-notion-gray-dark/40">
          <div className="mx-auto h-6 w-24 animate-pulse rounded-full bg-notion-gray-light dark:bg-notion-gray-dark"></div>
        </div>
      </div>
    );
  }
  ...
  return (
    <section className="relative overflow-hidden bg-notion-gray-light/10 py-notion-xl dark:bg-notion-gray-dark/20">
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-notion-lg flex items-end justify-between">
          <div>
            ...
            <div className="mt-2 h-1 w-16 bg-notion-pink"></div>
          ...
          <div className="hidden md:flex md:items-center md:gap-2">
            <button
              ...
              className="flex h-10 w-10 items-center justify-center rounded-full border border-notion-gray-light/30 text-notion-text-light/80 transition-colors hover:border-notion-pink hover:text-notion-pink dark:border-notion-gray-dark/40 dark:text-notion-text-dark/80 dark:hover:border-notion-pink-light dark:hover:text-notion-pink-light"
            >
            ...
            <div className="relative rounded-xl">
              ...
              >
                {trainers.map((trainer) => (
                  ...
                  >
                    <div className="flex flex-col gap-8 rounded-xl border border-notion-gray-light/20 bg-white p-6 shadow-notion dark:border-notion-gray-dark/30 dark:bg-notion-gray-dark/50 md:flex-row md:p-8">
                      ...
                      <div className="relative mx-auto w-48 md:mx-0">
                        <div className="relative">
                          <div className="overflow-hidden rounded-xl border-4 border-notion-pink/20 shadow-notion">
                            {trainer.image ? (
                              ...
                              <div className="flex h-48 w-48 items-center justify-center rounded-xl bg-notion-gray-light/30 dark:bg-notion-gray-dark/50">
                          ...
                          {trainer.verificationStatus === "verified" && (
                            <div className="absolute bottom-0 right-0 flex h-10 w-10 translate-x-1/4 translate-y-1/4 items-center justify-center rounded-full bg-notion-pink text-white shadow-lg">
                      ...
                      <div className="relative z-10 flex-1 md:pl-4">
                        ...
                        <div className="mx-auto mt-2 h-1 w-12 bg-notion-pink md:mx-0"></div>
                        ...
                        <div className="mt-6 space-y-4">
                          <div className="flex justify-center pt-4 md:justify-start">
                            <Link
                              ...
                              className="inline-flex items-center gap-1.5 rounded-lg bg-notion-pink px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-notion-pink-dark"
                            >
                              View Profile
                ...
                {trainers.map((_, index) => (
                  <button
                    ...
                    className={`h-2 w-2 rounded-full transition-all ${
                      index === activeIndex
                        ? "w-6 bg-notion-pink"
                        : "bg-notion-gray-light/50 hover:bg-notion-gray-light dark:bg-notion-gray-dark/60 dark:hover:bg-notion-gray-dark"
                    }`}
                  ></button>
                ))}
              </div>
