...
export default async function CourseDetailPage({
  ...
  return (
    <main className="min-h-screen space-y-8 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
      {/* Back Navigation */}
      <Link
        href="/trainer"
        className="group inline-flex items-center gap-1.5 rounded-lg bg-notion-gray-light/10 px-4 py-2 font-geist text-sm font-medium text-notion-text-light/80 transition-all hover:bg-notion-pink hover:text-white dark:bg-notion-gray-dark/30 dark:text-notion-text-dark/90 dark:hover:bg-notion-pink dark:hover:text-white"
      >
        <ChevronLeft
          size={16}
      ...
      <div className="space-y-8">
        {/* Course Header Card */}
        <section className="overflow-hidden rounded-xl border border-notion-gray-light/20 bg-white shadow-sm transition-all hover:shadow-md dark:border-notion-gray-dark/30 dark:bg-notion-gray-dark/60">
