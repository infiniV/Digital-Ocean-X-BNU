    ...
    <main className="min-h-screen bg-notion-background p-notion-lg transition-colors duration-200 dark:bg-notion-background-dark">
      <div className="mx-auto max-w-7xl space-y-notion-xl">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Link
            href="/trainer/create"
            className="flex w-full items-center justify-center gap-2 rounded-lg bg-notion-pink px-5 py-2.5 font-geist text-sm font-medium text-notion-text shadow-sm transition-all hover:bg-notion-pink-dark hover:shadow-md dark:text-notion-text sm:w-auto"
          >
            <PlusCircle size={18} />
