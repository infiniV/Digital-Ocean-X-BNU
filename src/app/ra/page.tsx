      ...
      <div className="animate-fade-in">
        <div className="flex flex-col gap-notion-xs">
          ...
          <p className="max-w-2xl font-geist text-base text-notion-text-light/70 dark:text-notion-text-dark/70 sm:text-lg">
            Meet our dedicated Research & Outreach Analysts who drive engagement, innovation, and impact for women empowerment.
          </p>
        </div>
      </div>
          ...
          {analysts.map((analyst) => (
            ...
            >
              ...
              <div className="relative z-10 flex flex-col items-center p-6">
                <div className="relative mb-4 flex h-20 w-20 items-center justify-center overflow-hidden rounded-full border-4 border-notion-pink/20 bg-white shadow-notion transition-all duration-300 group-hover:scale-105 dark:border-notion-accent-light">
                  {analyst.image ? (
                    <Image
                      src={analyst.image}
                      alt={analyst.name}
                ...
                <h3 className="mb-2 mt-1 font-geist text-sm text-notion-accent-dark dark:text-notion-accent-light">
                  {analyst.title}
                </h3>
                <p className="text-center font-geist text-sm text-notion-text-light/80 dark:text-notion-text-dark/80 line-clamp-4 min-h-[4.5rem]">
                  {analyst.bio}
                </p>
              </div>
